...
import com.mingwei.myprocess.model.OnLongClickMethod;
...
public class BindViewProcessor extends AbstractProcessor {
    ...
    private void processOnLongClick(RoundEnvironment roundEnvironment){
        for (Element element : roundEnvironment.getElementsAnnotatedWith(OnLongClick.class)){
            AnnotatedClass annotatedClass = getAnnotatedClass(element);
            OnLongClickMethod method = new OnLongClickMethod(element);
